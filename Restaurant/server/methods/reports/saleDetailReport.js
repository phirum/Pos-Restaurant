Meteor.methods({
    restaurantSaleDetailReport: function (arg) {
        var data = {
            title: {},
            header: {},
       ...
       // params.transactionType = "Sale";
        ...
        if (staffId != null && staffId != "")
            staff = Restaurant.Collection.Staffs.findOne(staffId).name;
...
function getSaleProducts(params, categoryId) {
    ...
    result.forEach(function (r) {
        var product = Restaurant.Collection.Products.findOne(r.productId);
        grandTotal += r.amount;
